...
const Layout: React.FC = () => {
  ...
  return (
    <div className="h-screen bg-gray-50 dark:bg-gray-900 flex flex-col flex-grow">
      {/* Header */}
      ...
      {/* Main Content */}
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col h-full">
        <Outlet />
      </main>
    </div>
  );
